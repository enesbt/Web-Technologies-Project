...
function muze(){
  let muze=`
    ...
    <div class="col-sm-6 col-md-6 mt-4">
     <div class="card" style="width:100%;">
       ...
       <div class="card-body">
         ...
         <a href="https://tr.wikipedia.org/wiki/Anadolu_Medeniyetleri_M%C3%BCzesi" target="_blank" class="btn btn-primary">Daha Fazla</a>
       </div>
     </div>
    </div>
    <div class="col-sm-6 col-md-6 mt-4">
    <div class="card" style="width: 100%;">
     ...
     <div class="card-body">
       ...
       <a href="https://tr.wikipedia.org/wiki/Ankara_Etnografya_M%C3%BCzesi" class="btn btn-primary" target="_blank">Daha Fazla</a>
     </div>
   </div></div>
  </div>
  <div class="row mt-5">
  <div class="col-sm-6 col-md-6 mt-4">
   <div class="card" style="width:100%;">
     ...
     <div class="card-body">
       ...
       <a href="https://tr.wikipedia.org/wiki/Kurtulu%C5%9F_Sava%C5%9F%C4%B1_M%C3%BCzesi" class="btn btn-primary" target="_blank">Daha Fazla</a>
     </div>
   </div>
  </div>
  <div class="col-sm-6 col-md-6 mt-4">
  <div class="card" style="width: 100%;">
   ...
   <div class="card-body">
     ...
     <a href="https://tr.wikipedia.org/wiki/%C3%87engelhan_Rahmi_M._Ko%C3%A7_M%C3%BCzesi" target="_blank" class="btn btn-primary">Daha Fazla</a>
   </div>
 </div></div>
</div>
<div class="row mt-5">
<div class="col-sm-6 col-md-6 mt-4">
 <div class="card" style="width:100%;">
   ...
   <div class="card-body">
     ...
     <a href="https://tr.wikipedia.org/wiki/Ulucanlar_Cezaevi_M%C3%BCzesi" target="_blank" class="btn btn-primary">Daha Fazla</a>
   </div>
 </div>
</div>
<div class="col-sm-6 col-md-6 mt-4">
<div class="card" style="width: 100%;">
 ...
 <div class="card-body">
   ...
   <a href="https://tr.wikipedia.org/wiki/PTT_Pul_M%C3%BCzesi" target="_blank" class="btn btn-primary">Go somewhere</a>
 </div>
</div></div>
</div>
